  ...
  return (
    ...
    >
      <View style={styles.inner}>
        {sent ? (
          <>
            <Eyebrow style={{ marginBottom: 10 }}>EMAIL SENT</Eyebrow>
            <Display size={30}>Check your inbox.</Display>
          ...
          <>
            <Eyebrow style={{ marginBottom: 10 }}>ACCOUNT RECOVERY</Eyebrow>
            <Display size={30}>Reset your{'\n'}password.</Display>
            <Text style={[styles.body, { color: colors.textMuted }]}>
